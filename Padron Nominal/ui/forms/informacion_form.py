...
class InformacionInfanteForm(tk.Toplevel):
    def __init__(self, parent):
        ...
        btn_frame.grid(row=0, column=3, rowspan=8, padx=12, pady=6, sticky="n")
        ...
        cols = ["DNI_Infante","ID_SeguimientoNominal","Nombres_Infante","Apellidos_Infante","FechaNacimiento","CRED","Vacunas","Suplementacion","Dosaje_Hb","Anemia","Tratamiento_Anemia","PadronNominal_Actualizado"]
